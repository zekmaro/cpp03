...
/*   Updated: 2024/10/10 17:01:43 by anarama          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack( const std::string& target ) {
	if (this->_health <= 0 ) {
		std::cout << "ClapTrap " << this->getName() << " cant attack. It's dead!" << std::endl;
		return ;
	}
	if (this->_energy <= 0 ) {
		std::cout << "ClapTrap " << this->getName() << " cant attack. It has no energy!" << std::endl;
		return ;
	}
...
void ClapTrap::takeDamage( unsigned int amount ) {
	if (this->_health <= 0 ) {
		std::cout << "ClapTrap " << this->getName() << " cant take more damage. It's dead!" << std::endl;
		return ;
	}
